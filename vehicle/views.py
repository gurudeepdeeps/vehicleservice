...
def customer_signup_view(request):
    ...
    if request.method=='POST':
        ...
        if userForm.is_valid() and customerForm.is_valid():
            ...
            messages.success(request, 'Customer signup successful. Please login to continue.', extra_tags='customer-signup')
            return HttpResponseRedirect('customerlogin')
        messages.error(request, 'Please correct the errors below and submit again.', extra_tags='customer-signup')
...
def mechanic_signup_view(request):
    ...
    if request.method=='POST':
        ...
        if userForm.is_valid() and mechanicForm.is_valid():
            ...
            messages.success(request, 'Mechanic signup successful. Please wait for admin approval before logging in.', extra_tags='mechanic-signup')
            return HttpResponseRedirect('mechaniclogin')
        messages.error(request, 'Please correct the errors below and submit again.', extra_tags='mechanic-signup')
